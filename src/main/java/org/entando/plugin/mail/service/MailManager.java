...
public class MailManager {
    ...
    @Autowired
    public MailManager(SmtpServerConfigRepository smtpRepository, EmailSenderRepository senderRepository,
    ...
    public void sendMail(SendMailRequest mailRequest) {
        ...
        try (Transport bus = prepareTransport(session)) {
            ...
            if (!StringUtils.isEmpty(mailRequest.getTemplateName())) {
                body = replaceTemplateParams(mailRequest.getTemplateName(), mailRequest.getTemplateParams());
            }
    ...
    private String replaceTemplateParams(String templateName, Map<String, String> params) {
