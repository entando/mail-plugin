package org.entando.plugin.mail.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("entandoMailPlugin");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("entandoMailPlugin");
        ...
        config.getMapConfigs().put("org.entando.plugin.mail.domain.*", initializeDomainMapConfig(jHipsterProperties));
